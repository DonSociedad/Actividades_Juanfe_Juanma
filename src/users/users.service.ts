...
export class UsersService implements UserServiceInterface {
  ...
  async login(loginDto: LoginDto): Promise<{ phoneCode: string; user: User }> {
    ...
    await user.save();
    await this.smsService.sendAccessSms(user.phone, phoneCode, user.name);
    return {
      phoneCode,
  ...
  async generateToken(
    VerifyPhoneCodeDto: VerifyPhoneDto,
